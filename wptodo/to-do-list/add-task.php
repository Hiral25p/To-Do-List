...
<body>
    ...
    <div class="container">
        ...
        <form class="ml30 mr30 mt20 flex-clm" action="print.php" id="add-task-form" method="POST" enctype="multipart/form-data">
            <div class="flex-row">
                <div class="form-item">
                    <textarea id="username" name="username" class="pl10 pr10 pt5 pb5 form-input form-textarea fs-20" type="text" autocomplete="off" placeholder=" "></textarea>
                    <label for="username" class="form-label pl10 fs-20">Enter Your Name<span class="red-text">*</span></label>
                    <div id="username" class="error red-text fs-10"></div>
                </div>
            </div>       
        <div class="flex-row">
                <div class="form-item">
